...
export default function DrinkList() {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      setDrinks(prev => prev.filter(drinks => drinks.id !== id));
  ...
  return (
    <div className="p-6  min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-[#4b2e2e]">Our Drink</h2>
        <button
      ...
      {loading ? (
        ...
        <p className="text-center text-gray-500">No Drink available</p>
      ) : (
